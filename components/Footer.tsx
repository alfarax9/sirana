        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Platform terintegrasi untuk otomatisasi regulasi dan edukasi
              Kedaruratan menggunakan teknologi Natural Language Processing
              (NLP) yang membantu masyarakat dalam pelaporan dan pemahaman
        ...
        <div className="border-t border-gray-700 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 SiRANA. Dikembangkan untuk keselamatan masyarakat
              Indonesia.
            </p>
